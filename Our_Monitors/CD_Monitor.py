...
def CDM(L_dev, Y_dev, k = 2, sig = 0.01, verbose = False):
	...
	def get_p_vals_tables(CT_list, sig, k, delta = 0):
		...
		return CD_edges, CD_nodes_sorted_by_no_of_edges, CT_list_2

	# retrieve modified CTs & tuples of LFs that are conditionally independent
	CD_edges, CD_nodes_sorted_by_no_of_edges, CT_list_2 = get_p_vals_tables(CT_list, sig = sig, k = k, delta = 1)
	#if verbose:
	...
	return CD_edges, CD_nodes_sorted_by_no_of_edges
